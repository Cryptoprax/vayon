...
requireText(adaptive, /Open Sample Workspace/, "A sample workspace path must be offered.");
...
if (/WorkspaceSetupCenter|ExecutiveActivationCards/.test(home)) failures.push("Generic competing onboarding must not render on the adaptive home.");
