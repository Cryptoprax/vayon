...
for (const surface of ["Today's Recommendation", "Content Queue", "Campaign Pipeline", "Publishing Status", "Brand Health", "Community Growth", "Traffic Snapshot", "Lead Generation", "Upcoming Launches", "Recent Wins"]) requireText(overview, new RegExp(surface.replace("'", "&apos;")), `Overview is missing ${surface}.`);
...
requireText(cmo, /Never auto-publishes/, "AI CMO approval boundary is missing.");
requireText(cmo, /Prepare recommendation/, "AI CMO preparation action is missing.");
