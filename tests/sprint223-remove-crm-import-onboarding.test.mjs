...
test("dashboard exposes the required Getting Started checklist",()=>{const checklist=read("features/vayon/dashboard/components/GettingStartedChecklist.tsx"),dashboard=read("features/vayon/dashboard/components/DashboardShell.tsx");for(const item of ["Create First Property","Create First Lead","Invite Your Team","Create First Task","Promote a Property","Business details and optional setup"])assert.ok(checklist.includes(item));assert.match(dashboard,/<GettingStartedChecklist data={data} \/>/)});
