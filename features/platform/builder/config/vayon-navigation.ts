...
export const vayonNavigation: readonly NavigationItem[] = [
  ...
  { id: "vayon-workforce", label: "Workforce", href: "/vayon/ai/workforce", icon: "W", surface: "sidebar", order: 13, visible: true, moduleId: "crm", permission: { anyOf: ["crm.read", "crm.records.manage"] } },
  ...
  { id: "vayon-marketing", label: "Marketing", href: "/vayon/creative", icon: "M", surface: "sidebar", order: 15.5, visible: true, moduleId: "crm", featureId: "marketing_studio", permission: { anyOf: ["crm.read", "crm.records.manage"] } },
