...
export class SalesAIService {
  private readonly projectionCache = new WeakMap<object, SalesAIDashboard>();
  ...
  private project(evidence: SalesEvidence): SalesAIDashboard {
    const cached = this.projectionCache.get(evidence);
