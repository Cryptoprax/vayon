...
export function FounderBootstrapPanel({
  ...
  return <WorkspaceContent >
    <WorkspaceHeader><p className="text-xs font-semibold uppercase tracking-[.2em] text-vds-primary">Founder Portal</p><h1 className="mt-2 text-3xl font-semibold">Founder access</h1><p className="mt-2 max-w-3xl text-sm text-vds-muted">Provision allowlisted, existing accounts through trusted Supabase Auth application metadata. Every mutation is re-authorized on the server.</p></WorkspaceHeader>
