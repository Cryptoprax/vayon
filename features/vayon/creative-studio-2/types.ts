...
export type ExportFormat =
  "PNG" | "JPG" | "SVG" | "PDF" | "PPTX" | "DOCX" | "HTML" | "MP4";

export interface CreativeModule {
  readonly id: CreativeModuleId;
  readonly name: string;
  readonly outcome: string;
  readonly availability: "available" | "foundation";
}
export interface CreativeProject {
  readonly id: string;
  readonly name: string;
  readonly status: CreativeCampaign["status"];
...
export interface CreativeStudio2Snapshot {
  ...
  readonly governance: {
    ...
    readonly providerState: "Configured" | "WaitingProvider";
