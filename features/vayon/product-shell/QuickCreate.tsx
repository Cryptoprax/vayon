...
const actions = quickCreateActions.filter(item => item.kind === "quick-create" && isCustomerRouteExposed(item.href)).map(item => ({ ...item, href: canonicalCustomerHref(item.href), icon: Plus }));
